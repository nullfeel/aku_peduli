<?php
include_once '../modules/auth/procces_login.php';
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-4 p-sm-5">
                                        ...
                                        <p class="card-text mb-5">Silakan Masukan NIK dan Nama Lengkap Anda.</p>
                                        ...
                                        <?php if(isset($resp)){ echo '<div class="alert border-0 border-info border-start border-4 bg-light-info alert-dismissible fade show py-2" role="alert">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <!-- <div class="col-6 text-end"><a href="authentication-forgot-password.html">Forgot Password ?</a></div> -->
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                ...
                                                <div class="col-12">
                                                    <p class="mb-0">Don't have an account yet? <a href="index.php?url=register">Sign up here</a></p>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
